...
echo "KadathThorn: Detect settings - KADATH_LIB_DIRS : ${KADATH_LIB_DIRS} ${GSL_LIB_DIRS} ${FFTW3_LIB_DIRS} ${BLAS_LIB_DIRS} ${LAPACK_LIB_DIRS} ${BOOST_LIB_DIRS}"
...
echo "KADATH_LIB_DIRS = ${KADATH_LIB_DIRS} ${GSL_LIB_DIRS} ${FFTW3_LIB_DIRS} ${BLAS_LIB_DIRS} ${LAPACK_LIB_DIRS} ${BOOST_LIB_DIRS}"
